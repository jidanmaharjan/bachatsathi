...
const Sidenav = () => {
  ...
  return (
    <div className={`fixed ${!side && 'translate-x-[-18rem] 2xl:translate-x-[-20rem]'} transition-transform duration-300 ease-in-out  z-50 w-72 2xl:w-80 min-h-screen p-2 bg-gray-100 mr-2 2xl:text-lg`}>
